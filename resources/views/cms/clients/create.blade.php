            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('clients.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="user_type" class="col-md-4 col-form-label text-md-end">{{ __('Client Type') }}</label>
                            <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="id_img" class="col-md-4 col-form-label text-md-end">{{ __('ID image') }}</label>

                            <div class="col-md-6">
                                <input id="id_img" type="file" accept="image/*" class="form-control" name="id_img"  autocomplete="id_img">
                            </div>
                        </div>
